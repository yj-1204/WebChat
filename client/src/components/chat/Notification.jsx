...
const Notification = () => {
    ...
    const { notifications, userChats, allUsers, markAllNotificationsAsRead, markNotificationAsRead,markThisUserNotificationsAsRead } = useContext(ChatContext);
                ...
                <div className="notifications-box">
                    <div className="notifications-header">
                        ...
                        {modifiedNotifications.map((n, index) => {
                            ...
                            return (
                                <div key={n._id} className={n.isRead ? 'notification' : 'notification-not-read'} onClick={() => markNotificationAsRead(n, userChats, user, notifications).setIsOpen(false)}>
