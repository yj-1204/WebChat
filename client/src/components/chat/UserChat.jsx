...
console.log(recipientUser)
    ...
    return (
        <Stack gap = {3} direction="horizontal" className="user-card align-items-center p-2 justify-content-between" role="button" onClick={() =>{ if (thisUserNotifications?.length !==0){markThisUserNotificationsAsRead(thisUserNotifications,notifications)}}}>
            <div className="d-flex">
                ...
                <div className="text-content">
                    ...
                    <div className="text">
                        {latestMessage?.text && <span> {truncateText(latestMessage?.text)} </span>}</div>
                </div>
