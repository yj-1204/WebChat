...
const ChatBox = () => {
    ...
    console.log('Chat box recipient user :',recipientUser)
    ...
    return (  
        <Stack gap={4} className="chat-box">
            ...
            <Stack direction="horizontal" className="chat-input flex-grow-0" gap={3}>
                ...
                <InputEmoji value= {textMessage} onChange={setTextMessage} fontFamily="nunito" borderColor="rgba(72, 112, 223, 0.2"></InputEmoji>
